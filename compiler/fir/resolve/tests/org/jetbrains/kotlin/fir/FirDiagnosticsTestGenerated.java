...
public class FirDiagnosticsTestGenerated extends AbstractFirDiagnosticsTest {
    ...
    public static class Problems extends AbstractFirDiagnosticsTest {
        ...
        @TestMetadata("callOnEnumEntry.kt")
        public void testCallOnEnumEntry() throws Exception {
            runTest("compiler/fir/resolve/testData/resolve/problems/callOnEnumEntry.kt");
        }
        ...
        @TestMetadata("innerConstructorOnInstance.kt")
        public void testInnerConstructorOnInstance() throws Exception {
            runTest("compiler/fir/resolve/testData/resolve/problems/innerConstructorOnInstance.kt");
        }
